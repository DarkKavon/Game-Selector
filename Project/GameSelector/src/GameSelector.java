  ...
  {  
   ...
   GameSelector()
     {  
      try
        {
         autoResources = ResourceBundle.getBundle("resources.Games",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(autoResources.getString("GameSelector"));  
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new GameSelector(); }  
          });   
     }  
  }